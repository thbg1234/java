...
public class DB_UP_DATA {
	public static void main(String[] args) {
		...
		try {
			...
			// 4단계. SQL문 전송.
			//stmt.executeUpdate("update student set name='student1' where ID = '202195007'");
			stmt.executeUpdate("delete from student where ID = '202195007'");
